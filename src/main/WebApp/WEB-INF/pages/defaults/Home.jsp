          ...
          <div class="container">
              ...
              <div class="row header-top tr-header-top tr-hidden-769">
                  <div class="tr-container">
                      ...
                      <div class="col-lg-6 col-md-6 col-xs-12 tr-shiping tr-hidden-769" id="shipping"><a href="https://tngfashion.vn/chinh-sach-doi-hang-van-chuyen"><i>Free ship toàn quốc với đơn hàng nguyên giá >=500.000đ</i></a></div>
              ...
              <div id="tr-sticky-header" class="row header-top tr-header-top tr-hidden">
                  <div class="col-lg-3 col-md-3 col-xs-2 tr-menu-left tr-hidden">
                      <div id="tr-open-menu">
                          <a id="simple-menu" href="#sidr"><i class="icon-T">DN</i></a>
                      </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-xs-8 tr-logo tr-hidden">
                                            <a href="#">
                          <img src="https://st2.depositphotos.com/5943796/11378/v/950/depositphotos_113780940-stock-illustration-initial-letter-dn-green-swoosh.jpg" title="Web Ban hang DN" alt="DNshop" style="width: 104px; height: 70px; "/>
                      </a>
                                        </div>
                  <div class="col-lg-3 col-md-3 col-xs-2" id="welcome-cart">
                      <div class="welcome-top tr-welcome-top">
...
<script>
  Kuler.text_load_more = "Hi\u1ec3n th\u1ecb th\u00eam...";
  Kuler.text_no_results = "Kh\u00f4ng c\u00f3 k\u1ebft qu\u1ea3";
</script>                        <div id="cart" class="mini-cart tr-mini-cart">
  <button type="button" data-toggle="dropdown" data-loading-text="Đang xử lý..." class="btn tr-btn btn-inverse btn-block btn-lg dropdown-toggle">
      <i class="icon-F tr-icon">F</i>
    <span class="cart-product-total-number tr-cart">0</span>
  </button>

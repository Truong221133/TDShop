		...
		<div class="container-fluid">
			<div class="header-content">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${pageContext.request.contextPath}/home"><img src="img/DN.jpg" /></a>
				</div>
				...
				<div class="collapse navbar-collapse"
					...
					<div>
						...
						<ul class="main-nav">
							<li class="main-nav__item main-nav__item--custom"><a
								href="nu"> Nữ </a></li>
							<li class="main-nav__item main-nav__item--custom"><a
								href="nam"> Nam </a></li>
							<li class="main-nav__item main-nav__item--custom"><a
								href="tre-em"> Trẻ em </a></li>
							<li class="main-nav__item main-nav__item--custom"><a
								href="http://www.tngfashion.vn/dia-chi.html"> Địa chỉ </a></li>
						</ul>
					</div>
